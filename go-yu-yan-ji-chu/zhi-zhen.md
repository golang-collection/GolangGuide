...
转载自：[https://github.com/unknwon/the-way-to-go\_ZH\_CN/blob/master/eBook/04.9.md](https://github.com/unknwon/the-way-to-go_ZH_CN/blob/master/eBook/04.9.md) by unknown
...
intP存储了 i1 的内存地址；它指向了 i1 的位置，它引用了变量 i1。
...
![](https://github.com/unknwon/the-way-to-go_ZH_CN/raw/master/eBook/images/4.9_fig4.4.png?raw=true)

下面程序为我们展示了指针对string的例子。
...
![](https://github.com/unknwon/the-way-to-go_ZH_CN/raw/master/eBook/images/4.9_fig4.5.png?raw=true)
