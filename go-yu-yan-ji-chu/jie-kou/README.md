...
转载自：[https://github.com/unknwon/the-way-to-go\_ZH\_CN/blob/master/eBook/11.1.md](https://github.com/unknwon/the-way-to-go_ZH_CN/blob/master/eBook/11.1.md) by unknown

## 接口是什么

Go 语言不是一种 _“传统”_ 的面向对象编程语言：它里面没有类和继承的概念。

但是 Go 语言里有非常灵活的 **接口** 概念，通过它可以实现很多面向对象的特性。接口提供了一种方式来 **说明** 对象的行为：如果谁能搞定这件事，它就可以用在这儿。接口要实现的是做什么，而不是怎么做，由谁来做。
